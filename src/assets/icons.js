document.addEventListener("DOMContentLoaded", function() {
    ...
    const iconBaseURL = "https://raw.githubusercontent.com/walkxcode/Dashboard-Icons/master/png/";
    ...
    function addIconToService(serviceName, serviceElement) {
        const iconUrl = iconBaseURL + serviceName.toLowerCase().replace(/\s+/g, '-') + ".png";
